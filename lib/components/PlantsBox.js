...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    for(var plantName in this.props.plants){
      if(counter-- === 0) break;
      plants.push(React.createElement(Plant, {plantName: plantName, plantObj: this.props.plants[plantName], key: counter}));
    }
    return (
      React.createElement("div", {className: "PlantsBox"}, 
        React.createElement("h2", {className: "ui header"}, "Plants"), 
        plants, 

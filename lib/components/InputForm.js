  ...
  render: function() {
    ...
    for(var field in this.props.sample){
      if(field == "plant" || field == "insect"){
        ...
        form.push(React.createElement("select", {className: "ui dropdown "+field, ref: field}, options));
      }else{
    ...
    return (
      React.createElement("form", {className: "InputForm ui left input", onSubmit: this.handleSubmit}, 
        React.createElement("h4", {className: "ui header"}, "Add ", this.props.inputType), 
        form, 

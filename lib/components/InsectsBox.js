...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    for(var insectName in this.props.insects){
      if(counter-- === 0) break;
      insects.push(React.createElement(Insect, {insectName: insectName, insectObj: this.props.insects[insectName], key: counter}));
    }
    return (
      React.createElement("div", {className: "InsectsBox"}, 
        React.createElement("h2", {className: "ui header"}, "Insects"), 
        insects, 
